...
const MonitoringTableComponent: React.FC<MonitoringTableProps> = ({
  ...
  const privacyBlur = isPrivacyMode
    ? "blur-md select-none hover:blur-none transition-all duration-300"
    : "";
              ...
              >
                  ...
                  <EditableCell
                    ...
                    className={cn(
                      ...
                      log.callType === "res_in"
                        ...
                        : log.callType === "res_out"
                          ? "bg-pink-100 text-pink-600"
                          : log.callType === "booking_confirmation"
                            ? "bg-amber-100 text-amber-600"
                            : log.callType === "inq_in" ||
                                log.callType === "inq_out"
                ...
                <td className="p-4 text-center">
                  <div className="flex items-center justify-center gap-2">
                    ...
                    <button
                      onClick={() =>
                        onUpdate(log.id, "followUp", log.followUp + 1)
                      }
                ...
                <td className="p-4 text-right flex items-center justify-end gap-1">
                  {log.callType === "guest" && (
                    <button
                      onClick={() => {
                        const prefix =
                          ...
                          log.callType === "inq_out"
                            ? "out"
                            : "hi";
                        const text = `${prefix} ${log.roomNo} ${log.lastName} - ${log.guestReq} Thank you po // ${currentUser.toLowerCase()}`;
                      ...
                      className="p-2 text-black-300 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg transition-all"
                  ...
                  <button
                    ...
                    className="p-2 text-black-300 hover:text-emerald-600 hover:bg-emerald-50 rounded-lg transition-all"
                  ...
                  <button
                    ...
                    className="p-2 text-black-300 hover:text-red-500 hover:bg-red-50 rounded-lg transition-all"
                    title="Delete Entry"
                  >
                    <Trash2 size={18} />
                  </button>
...
const EditableCellComponent: React.FC<EditableCellProps> = ({
  ...
  return (
    <div
      ...
      className={cn(
        "cursor-pointer hover:text-primary transition-colors min-h-[1.5rem]",
        className,
      )}
    >
      {displayValue || (
